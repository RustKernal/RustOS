...
pub macro set_cursor_pos($row:expr, $col:expr){
    _set_cursor_pos($row, $col);
}

pub macro push_color() {
    
}

pub fn _push_color() {
    WRITER.lock().save_color();
}
...
#[doc(hidden)]
pub fn _set_colour(fg: Color, bg: Color) {
    use x86_64::instructions::interrupts;
    interrupts::without_interrupts(|| {
...
#[doc(hidden)]
pub fn _set_cursor_pos(row:usize, col:usize) {
    use x86_64::instructions::interrupts;
    interrupts::without_interrupts(|| {
